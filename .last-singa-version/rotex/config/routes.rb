ActionController::Routing::Routes.draw do |map|
  ...
  map.activate "activer/:key", :controller=>"people", :action=>"activate"
  ...
  map.resources :mandates, :as=>"mandats", :except=>[:show], :collection=>{:mandates_dyta=>[:get, :post], :mandates_dyli=>[:get, :post]}
