...
ActiveRecord::Schema.define(:version => 2) do
  ...
  create_table "folders", :force => true do |t|
    t.boolean  "is_given",             :default => false, :null => false
  ...
  add_index "folders", ["is_accepted"], :name => "index_folders_on_is_accepted"
  add_index "folders", ["is_given"], :name => "index_folders_on_is_given"
