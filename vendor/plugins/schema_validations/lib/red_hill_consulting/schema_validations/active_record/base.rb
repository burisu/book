        ...
        content_columns.each do |column|
          ...
          if column.required_on
            ...
            if column.type == :boolean
              validates_inclusion_of name, :on => column.required_on, :in => [true, false], :message => I18n.translate('activerecord.errors.messages.blank') # ActiveRecord::Errors.default_error_messages[:blank]
            else
