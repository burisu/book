  ...
  module Dyli
    module Controller
      ...
      module ClassMethods
        ...
        def dyli(name_db, attributes=:name, options={})
          ...
          code += "    content = "+attributes_hash.sort.collect{|attribute, v| "item.#{attribute}.to_s"}.join('+", "+')+"\n"
          if partial
    ...
    module View
      ...
      def dyli_tag(name_html, name_db, options={}, tag_options={}, completion_options={})
        ...
        options  = {:action => "unroll"}.merge(options)
...
ActionController::Base.send(:include, Moisson::Dyli::Controller)
ActionView::Base.send(:include, Moisson::Dyli::View)
